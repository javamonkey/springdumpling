...
public class DoNothingRemotePublishProvider implements RemotePSProvider {
	...
	public void publish(JoinPoint joinPoint, Object returnValue, RemotePublish pub) {
		System.out.println("DoNothingRemotePublishProvider: notify path="
				+ pub.path() + " ,target=" + joinPoint.getTarget() + " method:"
	...
	public void init(SpringBowl bowl) {
		...
		System.out.println("DoNothingRemotePublishProvider listen:"
				+ map.keySet());
	...
	public void publish(Object[] args, String path, boolean persist) {
		System.out.println("DoNothingRemotePublishProvider: publish path="
				+ path + Arrays.asList(args));
	}
}
